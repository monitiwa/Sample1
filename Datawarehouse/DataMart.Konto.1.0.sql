...
CREATE TABLE F_FoVePo_PlusProLauf (
		SK_FoVePo_PlusProLauf VARCHAR2(64 CHAR) NOT NULL,
		TA_Ladedatum DATE NOT NULL,
		TA_Lade_ID NUMBER(28 , 0) NOT NULL,
		TA_Aenderungsdatum DATE NOT NULL,
		TA_Aenderungs_ID NUMBER(28 , 0),
		...
		ist_FoVePos_zu_Lauf CHAR(1) NOT NULL,
...
CREATE TABLE F_InExOb_PlusProLauf (
		SK_InExObj_PlusProLauf VARCHAR2(64 CHAR) NOT NULL,
		TA_Ladedatum DATE NOT NULL,
		TA_Lade_ID NUMBER(28 , 0) NOT NULL,
		TA_Aenderungsdatum DATE NOT NULL,
		TA_Aenderungs_ID NUMBER(28 , 0),
		...
		ist_InExObj_zu_Lauf CHAR(1) NOT NULL,
...
CREATE TABLE Releasestand (
		...
		Modelldatum DATE DEFAULT to_date( '12.07.2017','DD.MM.YYYY') NOT NULL,
...
ALTER TABLE F_FoVePo_PlusProLauf ADD CONSTRAINT F_Ford_Verb_Pos_LSV_Lauf_PK PRIMARY KEY
	(TA_Ladedatum,
	 Stichtag_Beginn,
	 SK_FoVePo_PlusProLauf);

ALTER TABLE F_InExOb_PlusProLauf ADD CONSTRAINT F_InExObj_LSV_PK PRIMARY KEY
	(TA_Ladedatum,
	 Stichtag_Beginn,
	 SK_InExObj_PlusProLauf);
...
'aus KT06_BelegPosition_InEx_02_WBS.FK_KT01_Beleg oder (bei Ausgleich) über KT01_KT06_BL-> KT01_Beleg_BH.SK_Beleg.';
...
COMMENT ON COLUMN F_FoVePo_PlusProLauf.Anzahl_Einzuege IS
...
oder =0, falls kein Einzug)		

Datenschutz $-';

COMMENT ON COLUMN F_FoVePo_PlusProLauf.Anzahl_FoVe_Positionen IS
...
COMMENT ON COLUMN F_FoVePo_PlusProLauf.BetragInEuro IS
'aus KT06_KT10_Regulierung_BL->KT06_BelegPosition_KT01_BW-> KT06_BelegPosition_InEx_02_WBS.BetragInEuro
oder KT06_BelegPosition_KT01_BW-> KT06_BelegPosition_InEx_02_WBS.BetragInEuro (falls kein Einzug)';

COMMENT ON COLUMN F_FoVePo_PlusProLauf.Ford_Verb_Anlegezeitpunkt IS
' aus KT06_KT10_Regulierung_BL->KT06_BelegPosition_KT01_BW->KT01_Beleg_BH->KT01_Beleg_InEx_02_HBS.angelegt_am
oder KT06_BelegPosition_KT01_BW->KT01_Beleg_BH->KT01_Beleg_InEx_02_HBS.angelegt_am (falls kein Einzug)
 
Datenschutz $-';

COMMENT ON COLUMN F_FoVePo_PlusProLauf.ID_Ausgleichsgrund IS
'aus KT06_KT10_Regulierung_BL->KT06_BW->KT06_BelPos_Ausgl_InEx_02_WBS.C_Ausgleichsgrund
oder KT06_BW->KT06_BelPos_Ausgl_InEx_02_WBS.C_Ausgleichsgrund (falls kein Einzug)';

COMMENT ON COLUMN F_FoVePo_PlusProLauf.ID_Ausgleichsstatus IS
'aus KT06_KT10_Regulierung_BL->KT06_BW->KT06_BelPos_Ausgl_InEx_02_WBS.C_Ausgleichsstatus
oder KT06_BW->KT06_BelPos_Ausgl_InEx_02_WBS.C_Ausgleichsstatus (falls kein Einzug)';

COMMENT ON COLUMN F_FoVePo_PlusProLauf.ID_Ausnahmegrund IS
'aus KT06_KT10_Regulierung_BL->KT06_KT10_Regul_InEx_01_LBS.C_Postenkennzeichen_B
oder leer, falls kein Einzug';

COMMENT ON COLUMN F_FoVePo_PlusProLauf.ID_BelegHerkunft IS
' aus KT06_KT10_Regulierung_BL->KT06_BelegPosition_KT01_BW->KT01_Beleg_BH->KT01_Beleg_InEx_02_HBS.C_BelegHerkunft
oder KT06_BelegPosition_KT01_BW->KT01_Beleg_BH->KT01_Beleg_InEx_02_HBS.C_BelegHerkunft (falls kein Einzug)';

COMMENT ON COLUMN F_FoVePo_PlusProLauf.ID_Belegart IS
' aus KT06_KT10_Regulierung_BL->KT06_BelegPosition_KT01_BW->KT01_Beleg_BH->KT01_Beleg_InEx_02_HBS.C_Belegart
oder KT06_BelegPosition_KT01_BW->KT01_Beleg_BH->KT01_Beleg_InEx_02_HBS.C_Belegart (falls kein Einzug)';

COMMENT ON COLUMN F_FoVePo_PlusProLauf.ID_Buchungsdatum IS
'aus  KT06_KT10_Regulierung_BL->KT06_BelegPosition_KT01_BW->KT01_Beleg_BH->KT01_Beleg_InEx_02_HBS.Buchungsdatum
oder  aus KT06_BelegPosition_KT01_BW->KT01_Beleg_BH->KT01_Beleg_InEx_02_HBS.Buchungsdatum (falls kein Einzug)';

COMMENT ON COLUMN F_FoVePo_PlusProLauf.ID_Buchungskreis IS
'aus KT06_KT10_Regulierung_BL->KT06_BelegPosition_KT01_BW->KT06_BelegPosition_InEx_02_WBS.C_Buchungskreis
oder KT06_BelegPosition_KT01_BW->KT06_BelegPosition_InEx_02_WBS.C_Buchungskreis (falls kein Einzug)';

COMMENT ON COLUMN F_FoVePo_PlusProLauf.ID_Datum_vorheriger_LSV_Lauf IS
...
COMMENT ON COLUMN F_FoVePo_PlusProLauf.ID_Eingangszahlweg_vorges IS
...
oder KT06_BelegPosition_KT01_BW->KT02_KT06_BL-> KT02_Vertragskonto_BH->KT02_Partner_VK_InEx_01_HBS.C_Eingangszahlweg (falls kein Einzug)';

COMMENT ON COLUMN F_FoVePo_PlusProLauf.ID_Ford_Verb_Anlegedatum IS
' aus Datum-Teil von KT06_KT10_Regulierung_BL->KT06_BelegPosition_KT01_BW->KT01_Beleg_BH->KT01_Beleg_InEx_02_HBS.angelegt_am
oder Datum-Teil von KT06_BelegPosition_KT01_BW->KT01_Beleg_BH->KT01_Beleg_InEx_02_HBS.angelegt_am (falls kein Einzug)';

COMMENT ON COLUMN F_FoVePo_PlusProLauf.ID_HauptTeilvorgang IS
'aus KT06_KT10_Regulierung_BL->KT06_BelegPosition_KT01_BW->KT06_BelegPosition_InEx_02_WBS.C_Hauptvorgang~....C_Teilvorgang 
oder KT06_BelegPosition_KT01_BW->KT06_BelegPosition_InEx_02_WBS.C_Hauptvorgang~....C_Teilvorgang  (falls kein Einzug)';

COMMENT ON COLUMN F_FoVePo_PlusProLauf.ID_InEx_Produktgruppe IS
'aus KT06_KT10_Regulierung_BL->KT06_BelegPosition_KT01_BW->KT06_BelegPosition_InEx_02_WBS.C_InEx_Produktgruppe 
oder KT06_BelegPosition_KT01_BW->KT06_BelegPosition_InEx_02_WBS.C_InEx_Produktgruppe  (falls kein Einzug)';

COMMENT ON COLUMN F_FoVePo_PlusProLauf.ID_LSV_Laufdatum IS
'aus  KT06_KT10_BL->KT10_BH->KT10_ZahllaufZahl_InEx_01_HBS.Laufdatum
oder leer, falls kein Einzug';

COMMENT ON COLUMN F_FoVePo_PlusProLauf.SK_FoVePo_PlusProLauf IS
'aus KT06_KT10_Regulierung_BL.SK_KT06_KT10_Regulierung
und aus KT06_Belegposition_KT01_BW.SK_KT06_Belegposition';

COMMENT ON COLUMN F_FoVePo_PlusProLauf.SK_Ford_Verb_Position IS
'aus KT06_KT10_Regulierung_BL.FK_KT06_BelegPosition
oder KT06_BelegPosition_KT01_BW.SK_KT06_Belegposition (falls kein Einzug)';

COMMENT ON COLUMN F_FoVePo_PlusProLauf.SK_Forderung_Verbindlichkeit IS
'aus  KT06_KT10_Regulierung_BL->KT06_BelegPosition_KT01_BW.FK_KT01_Beleg 
oder KT06_BelegPosition_KT01_BW.FK_KT01_Beleg  (falls kein Einzug)';

COMMENT ON COLUMN F_FoVePo_PlusProLauf.SK_InExkassoObjekt IS
'aus KT06_KT10_Regulierung_BL->KT06_BelegPosition_KT01_BW->KT05_KT06_BL.FK_KT05_InExkassoobjekt
oder aus KT06_BelegPosition_KT01_BW->KT05_KT06_BL.FK_KT05_InExkassoobjekt (falls kein Einzug)';

COMMENT ON COLUMN F_FoVePo_PlusProLauf.SK_LSV_Lauf IS
'aus  KT06_KT10_BL->KT10_BH->KT10_ZahllaufZahl_InEx_01_HBS.Laufdatum
und aus  KT06_KT10_BL->KT10_BH->KT10_ZahllaufZahl_InEx_01_HBS.Laufkennung
oder leer, falls kein Einzug';

COMMENT ON COLUMN F_FoVePo_PlusProLauf.SK_Partner IS
'aus KT06_BH->PA01_PA02_KT06_BL.FK_PA01_Partner (mit Rolle=InExkassopartner)';

COMMENT ON COLUMN F_FoVePo_PlusProLauf.SK_Vertragskonto IS
'aus KT06_KT10_Regulierung_BL->KT06_BelegPosition_KT01_BW->KT02_KT06_BL.FK_KT02_Vertragskonto
oder KT06_BelegPosition_KT01_BW->KT02_KT06_BL.FK_KT02_Vertragskonto (falls kein Einzug)';

COMMENT ON COLUMN F_FoVePo_PlusProLauf.Stichtag_Beginn IS
'Erster Stichtag, an dem der Datensatz Gültigkeit hat.
 
Datenschutz $-';

COMMENT ON COLUMN F_FoVePo_PlusProLauf.Stichtag_Ende IS
'Erster Stichtag, an dem der nächste Datensatz gültig ist, also der vorliegende Datensatz keine Gültigkeit mehr hat.

Datenschutz $-';

COMMENT ON COLUMN F_FoVePo_PlusProLauf.TA_Aenderungs_ID IS
'... ist die Identifizierung des entsprechenden Ladejobs, in dem dieser Tabellen-Eintrag als "fachlich nicht mehr gültig" markiert wurde.

Datenschutz $-';

COMMENT ON COLUMN F_FoVePo_PlusProLauf.TA_Aenderungsdatum IS
'... ist der Beginn (bis Minute) des jeweiligen Gesamt-Lade-Jobs, in dem dieser Satz als "fachlich nicht mehr gültig" markiert wurde. Es entspricht dem ''TA_Ladedatum'' des ersetzenden Satzes, falls ein solcher existiert.
Identifiziert damit eindeutig, wann die Daten aus dem Business Vault extrahiert wurden.

Datenschutz $-';

COMMENT ON COLUMN F_FoVePo_PlusProLauf.TA_Ersatz_ID IS
'... ist die Identifizierung des entsprechenden Ladejobs, in dem dieser Satz rückwirkend korrigiert wurde.

Datenschutz $-';

COMMENT ON COLUMN F_FoVePo_PlusProLauf.TA_Ersatzdatum IS
'... identifiziert bei korrigierten Sätzen, wann der Datensatz gem. Historisierungskonzept durch einen oder mehrere aktuelle Sätze ersetzt worden ist. Es entspricht dem ''TA_Ladedatum'' der ersetzenden Sätze.
...
COMMENT ON COLUMN F_FoVePo_PlusProLauf.TA_Lade_ID IS
'... ist die Identifizierung des entsprechenden Ladejobs, in dem dieser Tabellen-Eintrag geladen wurde.

Datenschutz $-';

COMMENT ON COLUMN F_FoVePo_PlusProLauf.TA_Ladedatum IS
'... ist der Beginn (bis Minute) des jeweiligen Gesamt-Lade-Jobs, in dem auch dieser Satz vom Quellsystem ins Data Warehouse geladen wurde.
Identifiziert damit eindeutig, wann die Daten aus dem Quellsystem extrahiert wurden.

Datenschutz $-';

COMMENT ON COLUMN F_FoVePo_PlusProLauf.ist_FoVePos_zu_Lauf IS
'... hält fest, ob diese Belegposition zu einem LSV-Lauf (ja) oder davon unabhängig hier dargestellt wird (nein).

Werte: ja/nein';

COMMENT ON COLUMN F_FoVePo_PlusProLauf.ist_LSV_relevant IS
...
Belegpositionen in Rahmen eines LSV-Laufs (auch mit Ausnahmengrund) sind immer LSV-relevant.

Werte: ja/nein';

COMMENT ON COLUMN F_InExOb_PlusProLauf.Anzahl_InExObjekte IS
...
COMMENT ON COLUMN F_InExOb_PlusProLauf.ID_Eingangszahlweg_vorges IS
'aus KT05_BH->KT02_KT05_BL->KT02_BH->KT02_Partner_VK_InEx_01_HBS.C_Eingangszahlweg';

COMMENT ON COLUMN F_InExOb_PlusProLauf.ID_InExObj_Anlegedatum IS
' aus Datum-Teil von  KT05_BH->KT05_InExkassoObj_InEx_01_HBS.angelegt_am';

COMMENT ON COLUMN F_InExOb_PlusProLauf.ID_InExObj_LieferungsArt IS
'aus 	KT05_InExkassoObj_InEx_01_HBS.C_Lieferung_faelligkeitbez

= "1 fälligkeitsbezogen", wenn C_Lieferung_faelligkeitbez=JA
= "0 änderungsbezogen", sonst';

COMMENT ON COLUMN F_InExOb_PlusProLauf.ID_InExkassoObjektArt IS
'aus KT05_BH->KT05_InExkassoObj_InEx_01_HBS.C_InkassoObjektArt';

COMMENT ON COLUMN F_InExOb_PlusProLauf.ID_InExkassoObjektTyp IS
'aus KT05_BH->KT05_InExkassoObj_InEx_01_HBS.C_InkassoObjektTyp';

COMMENT ON COLUMN F_InExOb_PlusProLauf.ID_LSV_Laufdatum IS
'aus KT05_BH->KT05_KT06_BL->KT06_BH-> KT06_KT10_BL->KT10_BH->KT10_ZahllaufZahl_InEx_01_HBS.Laufdatum
oder leer (falls nicht zu einem Einzug)';

COMMENT ON COLUMN F_InExOb_PlusProLauf.ID_StatusInExkassoObjekt IS
'aus KT05_BK-> KT05_InExkassoObj_InEx_01_HBS.C_StatusInkassoObjekt';

COMMENT ON COLUMN F_InExOb_PlusProLauf.ID_Vertragskontotyp IS
'aus KT05_BH->KT02_KT05_BL->KT02_BH->KT02_Vertragskonto_InEx_01_HBS.C_Vertragskontotyp';

COMMENT ON COLUMN F_InExOb_PlusProLauf.ID_Zahlweise_vertraglich IS
'aus KT05_BK-> KT05_InExkassoObj_InEx_01_HBS.C_Zahlweise_vertraglich';

COMMENT ON COLUMN F_InExOb_PlusProLauf.InExObj_Anlegezeitpunkt IS
'aus KT05_BH->KT05_InExkassoObj_InEx_01_HBS.angelegt_am
 
Datenschutz $-';

COMMENT ON COLUMN F_InExOb_PlusProLauf.Regelbeitrag_jaehrlich IS
...
COMMENT ON COLUMN F_InExOb_PlusProLauf.SK_InExObj_PlusProLauf IS
'aus KT05_InExkassoObj_InEx_01_HBS.FK_KT05_InExkassoObjekt (ohne Einzug)

und für InExkassoObjekt zu einem LSV-Lauf zusätzlich
aus KT05_BH->KT05_KT06_BL->KT06_BH-> KT06_KT10_BL->KT10_BH->KT10_ZahllaufZahl_InEx_01_HBS.Laufdatum
und aus KT05_BH->KT05_KT06_BL->KT06_BH-> KT06_KT10_BL->KT10_BH->KT10_ZahllaufZahl_InEx_01_HBS.Laufkennung';

COMMENT ON COLUMN F_InExOb_PlusProLauf.SK_InExkassoObjekt IS
'aus KT05_BH.SK_KT05_InExkassoObjekt';

COMMENT ON COLUMN F_InExOb_PlusProLauf.SK_LSV_Lauf IS
'aus KT05_BH->KT05_KT06_BL->KT06_BH-> KT06_KT10_BL->KT10_BH->KT10_ZahllaufZahl_InEx_01_HBS.Laufdatum
und aus KT05_BH->KT05_KT06_BL->KT06_BH-> KT06_KT10_BL->KT10_BH->KT10_ZahllaufZahl_InEx_01_HBS.Laufkennung,
oder leer (falls nicht zu einem Einzug)';

COMMENT ON COLUMN F_InExOb_PlusProLauf.SK_Partner IS
'aus KT05_InExkassoObjekt_BH->PA01_PA02_KT05_BL.FK_PA01_Partner (mit Rolle=InExkassopartner)';

COMMENT ON COLUMN F_InExOb_PlusProLauf.SK_Vertragskonto IS
'aus KT05_BH->KT02_KT05_BL->KT02_BH.SK_KT02_Vertragskonto';

COMMENT ON COLUMN F_InExOb_PlusProLauf.Stichtag_Beginn IS
'Erster Stichtag, an dem der Datensatz Gültigkeit hat.
 
Datenschutz $-';

COMMENT ON COLUMN F_InExOb_PlusProLauf.Stichtag_Ende IS
'Erster Stichtag, an dem der nächste Datensatz gültig ist, also der vorliegende Datensatz keine Gültigkeit mehr hat.

Datenschutz $-';

COMMENT ON COLUMN F_InExOb_PlusProLauf.TA_Aenderungs_ID IS
'... ist die Identifizierung des entsprechenden Ladejobs, in dem dieser Tabellen-Eintrag als "fachlich nicht mehr gültig" markiert wurde.

Datenschutz $-';

COMMENT ON COLUMN F_InExOb_PlusProLauf.TA_Aenderungsdatum IS
'... ist der Beginn (bis Minute) des jeweiligen Gesamt-Lade-Jobs, in dem dieser Satz als "fachlich nicht mehr gültig" markiert wurde. Es entspricht dem ''TA_Ladedatum'' des ersetzenden Satzes, falls ein solcher existiert.
Identifiziert damit eindeutig, wann die Daten aus dem Business Vault extrahiert wurden.

Datenschutz $-';

COMMENT ON COLUMN F_InExOb_PlusProLauf.TA_Ersatz_ID IS
'... ist die Identifizierung des entsprechenden Ladejobs, in dem dieser Satz rückwirkend korrigiert wurde.

Datenschutz $-';

COMMENT ON COLUMN F_InExOb_PlusProLauf.TA_Ersatzdatum IS
'... identifiziert bei korrigierten Sätzen, wann der Datensatz gem. Historisierungskonzept durch einen oder mehrere aktuelle Sätze ersetzt worden ist. Es entspricht dem ''TA_Ladedatum'' der ersetzenden Sätze.
...
COMMENT ON COLUMN F_InExOb_PlusProLauf.TA_Lade_ID IS
'... ist die Identifizierung des entsprechenden Ladejobs, in dem dieser Tabellen-Eintrag geladen wurde.

Datenschutz $-';

COMMENT ON COLUMN F_InExOb_PlusProLauf.TA_Ladedatum IS
'... ist der Beginn (bis Minute) des jeweiligen Gesamt-Lade-Jobs, in dem auch dieser Satz vom Quellsystem ins Data Warehouse geladen wurde.
Identifiziert damit eindeutig, wann die Daten aus dem Quellsystem extrahiert wurden.

Datenschutz $-';

COMMENT ON COLUMN F_InExOb_PlusProLauf.ist_InExObj_zu_Lauf IS
'... hält fest, ob dieses InExkassoObjekt zu einem LSV-Lauf (ja) oder davon unabhängig hier dargestellt wird (nein).
...
d.h. C_BelegHerkung = V1 Sollstellung
oder C_Belegart =
0		Migration
10	Forderung
17	PC Miete
19	ZfA Zulagenforderung
35	(33: Kostenforderung)
40	BUZ-Leistung
41	Leistungseinbehalt
70	Ford./Verb. Schaden
75	Ford./Verb. LL
...
COMMENT ON TABLE F_FoVePo_PlusProLauf IS
'aus KT06_KT10_Regulierung_BL mit KT06_KT10_Regulierung_BL->KT10_BH->KT10_InEx_01_HBS.Laufkennung=LSV* (ohne simulierte Läufe)

und direkt ohne Beachtung eines Einzugs aus KT06_BelegPosition_KT01_BW mit  ...->KT01_Beleg_BH->KT01_Beleg_InEx_02_HBS.C_Belegart = Forderung / Verbindlichkeit,
 C_Belegart =
10	Forderung
17	PC Miete
18 	Ford. Vorwegabzug
...
COMMENT ON TABLE F_InExOb_PlusProLauf IS
'Jedes gültige In ExkassoObjekt (unabhängig von einem LSV-Lauf), 
und für jeden LSV-Lauf jedes gültige InExkassoObjekt, das zu einem Vertragskonto mit mindestens einem InExkassoObjekt gehört, das beim zugehörigen LSV-Lauf beteiligt ist.

Diese Beteiligung ist über KT06_KT10_Regulierung_BL->KT06_BelegPosition_KT01_BW->KT05_KT06_BL-> KT05_InExkassoObjekt_BH->KT02_KT05__BL->KT02_Vertragskonto_BH->(*)KT02_KT06_BL->KT05_InExkassoObjekt_BH feststellbar.';
