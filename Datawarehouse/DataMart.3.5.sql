...
CREATE TABLE F_Zahlung_Detail (
		...
		ID_Waehrung NUMBER(28 , 0) NOT NULL,
		ID_Leistungsart NUMBER(28 , 0) NOT NULL,
		Teilbetrag NUMBER(19 , 5) NOT NULL,
		TeilbetragInEuro NUMBER(19 , 5) NOT NULL,
		SK_Schaden VARCHAR2(64 CHAR) NOT NULL,
		ID_Schadenmerkmale NUMBER(28 , 0) NOT NULL,
		ID_SchadUrsacheGef NUMBER(28 , 0) NOT NULL,
		ID_Schadenstatus_Detail NUMBER(28 , 0) NOT NULL,
...
CREATE TABLE Releasestand (
		...
		Modelldatum DATE DEFAULT to_date( '07.11.2018','DD.MM.YYYY') NOT NULL,
...
aus LE09_Rueckst_Bilanz_01_HBM.C_Bilanz_Meldeperiode
...
aus ER02_Teilschaden_SHUKR_01_WBS.C_Deckungsart harmonisiert
...
durch Harmonisierung aus LE02_Zahlung_Det_SHUKR_01_WBS.C_Leistungsart_B 
...
'aus ER01_Schaden_SHUKR_nn_HBS.C_Schadenursache';
...
'z.B. aus LE09_Rueckst_Bilanz_01_HBM.C_Bilanz_Meldeperiode';
...
'z.B. aus LE09_Rueckst_Bilanz_01_HBM.C_Rueckstellungsart';
...
aus LE09_Rueckst_Man_01_HBS.Buchungsdatum
