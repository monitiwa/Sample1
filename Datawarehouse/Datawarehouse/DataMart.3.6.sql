...
'Lookup über ID_SCHADENFLAGS => FEHLANLAGE';

COMMENT ON COLUMN AGG_SCHADEN_2.GJ_SCHADEN IS
'Lookup über ID_SCHADENFLAGS => GJ_SCHADEN';

COMMENT ON COLUMN AGG_SCHADEN_2.GJ_WIEDEREROEFFNET IS
'Lookup über ID_SCHADENFLAGS => GJ_WIEDEREROEFFNET ';

COMMENT ON COLUMN AGG_SCHADEN_2.GJ_WIEDEREROEFFNET_MONETAER IS
'Lookup über ID_SCHADENFLAGS => GJ_WIEDEREROEFFNET_MONETAER';
...
'Lookup über ID_VERTRAGSMERKMALE => ID_GROSSKUNDE';
...
'Lookup über ID_SCHADENFLAGS => OHNEENTSCHAEDIGUNG';
...
'...... ist das Datum, an dem der Schaden im Quartal zuletzt geändert wurde.
...
'... ist der Name der zuletzt im Quartal geänderten Quelltabelle';
...
Bea:	Wird nur im Klartext gefüllt, wenn Schutzkennzeichen = ''kein Zugriffsschutz'' oder wennn es kein Schutzkennzeichen gibt, 
		sonst: ''XXXX''
...
'Lookup auf DMK_Partnermerkmale.ID_Partnermerkmal mit den zum Stichtag gültigen Ausprägungen
...
mit GE02_KommAng_Par_01_HBS. C_Kommunikationstyp = ''Anschrift''
über DIM_Postleitzahl.ID_Postleitzahl 
...
'Lookup auf DMK_Regressmerkmale.ID_Regressmerkmale mit den zum Stichtag gültigen Ausprägungen

über  LE03_Regress_SHUKR_01_HBS
C_Regressart
C_Regressgrund
C_Regressstatus';
...
Bea: Datenqualität ist schlecht
...
Bea: Datenqualität ist schlecht und Verwendung in der Quelle ist unklar
...
aus LE03_Regress_SHUKR_01_HBS.geaendert_von_A (mit ''X'' für die letzte Stelle) 
...
aus LE04_Regresspos_SHUKR_01_WBS.geaendert_von_A (mit ''X'' für die letzte Stelle)
...
Bea: DMK_Schadenflags.ID_Schadenflags wird bei der Beladung von DET_Schaden erzeugt und verknüpft DET_Schaden und DMK_Schadenflags.
...
Bea: DMK_Schadenmerkm.ID_Schadenmerkmale wird bei der Beladung von DET_Schaden erzeugt und verknüpft DET_Schaden und DMK_Schadenmerkm.
...
Bea: DMK_SchadRueckstMerk.ID_Schadenrueckstmerkmale wird bei der Beladung von DET_Schadenrueckst erzeugt und verknüpft DET_Schadenrueckst und DMK_SchadRueckstMerk.
...
Bea: DMK_Teilschadenflags.ID_Teilschadenflags wird bei der Beladung von DET_Teilchaden erzeugt und verknüpft DET_Teilschaden und DMK_Teilschadenflags.
...
aus PA01_PA02_ER01_SHUKR_02_LBS.geaendert_von_A (mit * für die letzte Stelle des Arbeitsanteils)
...
Bea: DMK_VertragDeckMerkm.ID_VertragsdeckMerkmale  wird bei der Beladung von DET_Vertagsdeckung erzeugt und verknüpft DET_Vertagsdeckung und DMK_VertragDeckMerkm.
...
über LE01_Zahlung_SHUKR_02_HBS
C_SatzartDerZahlung
C_Zahlungsart
C_BruttoNetto
C_ZahlungStatus
...
aus LE01_Zahlung_SHUKR_01_HBS.angelegt_von_A (mit ''X'' für die letzte Stelle)
...
aus LE01_Zahlung_SHUKR_01_HBS.geaendert_von_A (mit ''X'' für die letzte Stelle)
...
aus LE01_Zahlung_SHUKR_01_HBS.geprueft_von_A (mit ''X'' für die letzte Stelle)
...
über LE02_Zahlung_Det_SHUKR_01_WBS
C_Betragstyp
C_Zahlungsart 
C_BruttoNetto 
C_Zahlungsgrund 
...
oder für Zahlungseingänge aus CD über
C_Betragstyp = "nicht geliefert" (-1)
C_Zahlungsart = "Rückzahlung" (99)
...
aus LE02_Zahlung_Det_SHUKR_01_WBS.geaendert_von_A (mit ''X'' für die letzte Stelle)

oder für Zahlungseingänge aus CD 
aus KT01_Beleg_InEx_01_HBS.geaendert_von_A (mit ''X'' für die letzte Stelle)
...
'gibt Informationen über die Art des Mahnverfahrens zu einer Forderung
...
'Langtext über die Art des Mahnverfahrens zu einer Forderung
...
ZU.002		ZU Gekürzte Abrechnungen                                       								Gekürzte Abrechnungen                                       
...
'Kurztext für Beschädigungsgrad

AU.000	Standardschaden
AU.001	Bagatellschaden
AU.002	Geringe Beschädigung
AU.003	Mittlere Beschädigung
AU.004	Starke Beschädigung
AU.005	Totalschaden
AU.006	Vermutlich Totalschaden
GE.001		Bagatellschaden
GE.002		Geringe Beschädigung
GE.003		Mittlere Beschädigung
GE.004		Starke Beschädigung
GE.005		Totalschaden
GE.006		Teilverlust
GE.007		Totalverlust
PE.001		Teilschaden
...
'Kurzbezeichnung für Beschädigungsgrad
...
'Langtext für Beschädigungsgrad
...
'Kurzbezeichnung für Beschädigungstyp
...
'Kurztext für die Art eines Betrags (z.B. Rückstellungsbetrag, Zahlbetrag, ...)
...
'Kurzbezeichnung für die Art eines Betrags (z.B. Rückstellungsbetrag, Zahlbetrag, ...)
...
'Langtext für die Art eines Betrags (z.B. Rückstellungsbetrag, Zahlbetrag, ...)
...
'Kurzbezeichnung für die Meldeperiode
...
'Kurztext für die Deckungssumme
...
'Kurzbezeichnung für die Deckungssumme
...
'Langtext für die Deckungssumme
...
'Kurztext für den Schritt im Eskalationsprozess
...
'Kurzbezeichnung für den Schritt im Eskalationsprozess
...
'Langtext für den Schritt im Eskalationsprozess
...
'Kurztext der Klassifizierungsart für einen Rueckstellungsbetrag (oder einen Regressbetrag)
...
'Kurzbezeichnung der Klassifizierungsart für einen Rueckstellungsbetrag (oder einen Regressbetrag)
...
'Langtext der Klassifizierungsart für einen Rueckstellungsbetrag (oder einen Regressbetrag)
...
aus allen Einträgen in MD16_Regionaldirektion
mit identischer
...
'Kurztext für die RD mit Präfix ''RD '' oder Zentrale, beides unter Einbeziehung von (z.B. ehemaligen) dazugehörigen RD-Bezeichnungen.

Beispiele: 
KL	RD Köln 			für Köln
SR	RD Schwerin	für Schwerin, Greifswalde, Restock, Cottbus, Frankfurt/Oder
BE	RD Berlin		für Berlin, Berlin/Ost
...
...
'Kurzbezeichnung für die RD mit Präfix ''RD '' oder Zentrale, beides unter Einbeziehung von (z.B. ehemaligen) dazugehörigen RD-Bezeichnungen.
...
'Langtext für die RD mit Präfix ''RD '' oder Zentrale, beides unter Einbeziehung von (z.B. ehemaligen) dazugehörigen RD-Bezeichnungen.
...
Kurz-	Langtext
N			Nord  			bestehend gemäß Ebene1 aus: 	Hannover, Hamburg, Münster
O			Ost  			bestehend gemäß Ebene1 aus:	Berlin, Schwerin, Erfurt, Dresdenr 
W			West  			bestehend gemäß Ebene1 aus: 	Köln, Essen, Wuppertal
SW		Südwest		bestehend gemäß Ebene1 aus:	Mainz, Frankfurt, Kassel, Saarbrücken 
S			Süd  			bestehend gemäß Ebene1 aus:	Nürnberg, Karlsruhe, Stuttgart, München, Regensburg 
Z			Zentrale		bestehend gemäß Ebene1 aus:	Zentrale
...
'Kurztext für das Land einer RD oder Zentrale

BRD

aus MD16_Reginaldirektion.Ebene3

Bea: mit Kurztext gefüllt

Datenschutz $-';

COMMENT ON COLUMN DIM_RD_Ebene3.RD_Ebene3_kurz IS
'Kurzbezeichnung für das Land einer RD oder Zentrale
...
'Langtext für das Land einer RD oder Zentrale
...
'Kurztext für die Ursache des Schadens gem. LOSSCAUSE aus ESA

z.B.
001	Kunde fährt auf
002	Jmd. fährt Kunde auf
003	Zusammenstoß allgemein
004	Zusammenstoß auf enger Straße
005	Jmd. stößt aus untergeordneter Straße auf VN
006	VN stößt aus untergeordneter Straße auf jmd.
007	Unfall Einzelfahrzeug - keine Schuld, da z.B. geparkt
008	Unfall Einzelfahrzeug - Schuld, z.B. VN fährt gegen Baum
009	Mehrfachunfall
...
...
'Kurzbezeichnung für die Ursache des Schadens gem. LOSSCAUSE aus ESA
...
'Langtext für die Ursache des Schadens gem. LOSSCAUSE aus ESA
...
'Kurztext für das Schutzkennzeichen zum Partner
...
'Kurzbezeichnung für das Schutzkennzeichen zum Partner
...
'Langtextfür das Schutzkennzeichen zum Partner
...
Hinweis: In der Beladung der MD37 ist sichergestellt, dass mindestens eines der drei Attribute gefüllt ist. 
';
...
'Kurzname des Rückversicherers, bei dem die technische Versicherung rückversichert wurde
...
41	m_Fürst					Fürst
42	w_Fürstin				Fürstin
51	m_Graf					Graf
52	w_Gräfin					Gräfin
61	m_Großherzog		Großherzog
62	w_Großherzogin	Großherzogin
71	m_Herzog				Herzog
72	w_Herzogin			Herzogin
81	m_Kaiser					Kaiser
82	w_Kaiserin				Kaiserin
91	m_König					König
92	w_Königin				Königin
101	m_Prinz					Prinz
...
'Kurztext für die Verfahrensart
...
'Kurzbezeichnung für die Verfahrensart
...
'wird bei der Befüllung erzeugt ';
...
und := ''Regress'' (2265) für Sätze aus LE03_REGRESS_BILANZ_01_HBM 
...
'Kennzeichen für die Identifizierung besonders geschützter Partner (Mitarbeiter, VIPs, Zeugenschutz,...)

ja (entspricht: 1 geschützt, 2 einfacher Schutz, 3 erweiterter Schutz, 4 besonderer Schutz, ...)
nein (entspricht  0 ungeschützt)
...
'konstant = ''Einzelschaden Rückstellung''';
...
'... gibt an, ob der Schaden seitens des Außendienstes reguliert wurde,
...
über alle zugehörigen Attributwerte in 
...
= Summe(KT06_BELEGPOSITION_INEX_01_WBS.BetragInEuro) für alle Belegpositionen zur Forderung, die zum Stichtag kein Ausgleichsbuchungsdatum aufweisen)
...
'Prioritaet, ab dem der XL greift, d.h. der quotierte Schadenaufwand muss über der Prioritaet liegen, damit der Schaden in den XL-Layer fällt.
...
'Kennzeichnet, ob sich der XL-Layer auf Unfall-rente - Fälle bezieht

J: Unfall-rente muss berücksichtigt werden --> ID_Rueckversicherung=10119
N: Unfall-rente Schäden sind nicht eingeschlossen --> ID_Rueckversicherung <>10119
-: Alle Schäden sind eingeschlossen
...
'Anzahl der der Vollmachten für Vertriebspartner DEVK
...
'Anzahl der der Vollmachten für Vertriebspartner Sparda
...
'Anzahl der Vollmachten für Vertriebspartner mit Vollmachtsstufe ''Einstieg''
...
'Anzahl der Vollmachten für Vertriebspartner mit Vollmachtsstufe ''Regel''
...
'Anzahl der Vollmachten für Vertriebspartner mit Vollmachtsstufe ''Spezial''
...
'Anzahl der Vollmachten für Bankbetreuer innerhalb der Vertriebspartner
...
'Anzahl der Vollmachten für Mitarbeiterberatungsstellen innerhalb der Vertriebspartner
...
'Anzahl der Vollmachten für Vertriebsleiter Sparda innerhalb der Vertriebspartner
...
'Anzahl der Vollmachten für Vertrauensmänner innerhalb der Vertriebspartner
...
'Anzahl der Vollmachten für die übrigen Vertriebspartner 
...
'Anzahl der Vollmachten für Vertriebspartner insgesamt
...
Enthält alle Zahlungseingänge zu gesicherten Regressen des Schadens vom Jahresbeginn bis zum Betrachtungszeitpunkt auf Entschädigungszahlungen.

Aktueller Wert abzüglich Vorjahresendwert (31.12.VJ 23:59:59) von F_SCHADEN.REGRESS_GESI_EINGANG_ENTSCH 

Datenschutz $-';

COMMENT ON COLUMN F_SCHADEN_YTD.REGR_GESI_EINGANG_RENTE_YTD IS
'Summe gesicherte Regresseingänge auf Rentenzahlungen.
Enthält alle Zahlungseingänge zu gesicherten Regressen des Schadens vom Jahresbeginn bis zum Betrachtungszeitpunkt auf Rentenzahlungen.

Aktueller Wert abzüglich Vorjahresendwert (31.12.VJ 23:59:59) von F_SCHADEN.REGRESS_GESI_EINGANG_RENTE 
...
Enthält alle Zahlungseingänge zu gesicherten Regressen des Schadens vom Jahresbeginn bis zum Betrachtungszeitpunkt auf äußeren Schadenregulierungsaufwendungen.

Aktueller Wert abzüglich Vorjahresendwert (31.12.VJ 23:59:59) von F_SCHADEN.REGRESS_GESI_EINGANG_SRK 
...
Enthält alle Zahlungseingänge zu ungesicherten Regressen des Schadens vom Jahresbeginn bis zum Betrachtungszeitpunkt auf Entschädigungszahlungen.

Aktueller Wert abzüglich Vorjahresendwert (31.12.VJ 23:59:59) von F_SCHADEN.REGRESS_UNGESI_EINGANG_ENTSCH 

Datenschutz $-';

COMMENT ON COLUMN F_SCHADEN_YTD.REGR_UNGESI_EINGANG_RENTE_YTD IS
'Summe ungesicherte Regresseingänge auf Rentenzahlungen.
Enthält alle Zahlungseingänge zu ungesicherten Regressen des Schadens vom Jahresbeginn bis zum Betrachtungszeitpunkt auf Rentenzahlungen.

Aktueller Wert abzüglich Vorjahresendwert (31.12.VJ 23:59:59) von F_SCHADEN.REGRESS_UNGESI_EINGANG_RENTE 
...
Enthält alle Zahlungseingänge zu ungesicherten Regressen des Schadens vom Jahresbeginn bis zum Betrachtungszeitpunkt auf äußeren Schadenregulierungsaufwendungen.

Aktueller Wert abzüglich Vorjahresendwert (31.12.VJ 23:59:59) von F_SCHADEN.REGRESS_UNGESI_EINGANG_SRK 

Datenschutz $-';

COMMENT ON COLUMN F_SCHADEN_YTD.RUECKSTELLUNGEN_SALDIERT_YTD IS
'Saldierte Schadenrückstellungen
Summe aller von Jahresbeginn bis zum Betrachtungszeitpunkt noch vorhandenen Rückstellungen für Entschädigungen, Äußere Schadenregulierung und Renten eines Schadens. Offene Anteile gesicherter Regresse werden dabei berücksichtigt.

Aktueller Wert abzüglich Vorjahresendwert (31.12.VJ 23:59:59) von F_SCHADEN.RUECKSTELLUNGEN_SALDIERT

Datenschutz $-';

COMMENT ON COLUMN F_SCHADEN_YTD.RUECKSTELLUNG_REIN_ENTSCH_YTD IS
'Reine Rückstellung für Entschädigungszahlungen.
Rückstellung, die von Jahresbeginn bis zum aktuellen Betrachtungszeitpunkt des (Teil-)Schadens für Aufwendungen der Entschädigungszahlungen noch existiert, also nicht durch Aufwendungen für die Entschädigungszahlungen aufgebraucht wurde. Umgebuchte Aufwendungen müssen berücksichtigt werden, Zahlungseingänge hingegen nicht.

Aktueller Wert abzüglich Vorjahresendwert (31.12.VJ 23:59:59) von F_SCHADEN.RUECKSTELLUNG_REIN_ENTSCH

Datenschutz $-';

COMMENT ON COLUMN F_SCHADEN_YTD.RUECKSTELLUNG_REIN_RENTE_YTD IS
'Reine Rentenrückstellung
Rückstellung, die von Jahresbeginn bis zum aktuellen Betrachtungszeitpunkt des (Teil-)Schadens für Rentenzahlungen noch existiert, also nicht durch Rentenzahlungen aufgebraucht wurde. Umgebuchte Rentenzahlungen müssen berücksichtigt werden, Zahlungseingänge hingegen nicht.

Aktueller Wert abzüglich Vorjahresendwert (31.12.VJ 23:59:59) von F_SCHADEN.RUECKSTELLUNG_REIN_RENTE

Datenschutz $-';

COMMENT ON COLUMN F_SCHADEN_YTD.RUECKSTELLUNG_REIN_SRK_YTD IS
'Reine Rückstellung für Äußere Schadenregulierung
Rückstellung, die von Jahresbeginn bis zum aktuellen Betrachtungszeitpunkt des (Teil-)Schadens für Aufwendungen der Äußeren Schadenregulierung noch existiert, also nicht durch Aufwendungen für die Äußere Schadenregulierung aufgebraucht wurde. Umgebuchte Aufwendungen müssen berücksichtigt werden, Zahlungseingänge hingegen nicht.

Aktueller Wert abzüglich Vorjahresendwert (31.12.VJ 23:59:59) von F_SCHADEN.RUECKSTELLUNG_REIN_SRK
...
Summe aller Zahlungen eines Schadensvon Jahresbeginn bis zu einem Betrachtungszeitpunkt. Berücksichtigt werden alle Ausgangszahlungen und Regresseingänge (gesichert und ungesichert).

Aktueller Wert abzüglich Vorjahresendwert (31.12.VJ 23:59:59) von F_SCHADEN.ZAHLUNGEN_SALDIERT
...
Die Summe Rentenzahlungen beinhaltet alle im Zuge der (Teil-)Schadenregulierung bis zum Betrachtungszeitpunkt t ausgehenden Zahlungen des Versicherers fÃ¼r Renten. Explizit nicht eingerechnet werden dabei ZahlungseingÃ¤nge. Umbuchungen mÃ¼ssen dagegen berÃ¼cksichtigt werden.
...
'Summe reine Aufwendungen für Äuere Schadenregulierung

Die Summe der reinen Aufwendungen für Äußere Schadenregulierung beinhaltet alle im Zuge der Schadenregulierung von Jahresbeginn bis zum Betrachtungszeitpunkt angefallenen Aufwendungen des Versicherers für die Äußere Schadenregulierung des (Teil-)Schadens. Zahlungseingänge werden dabei nicht berücksichtigt, Umbuchungen dagegen schon.

Aktueller Wert abzüglich Vorjahresendwert (31.12.VJ 23:59:59) von F_SCHADEN.ZAHLUNG_REIN_SRK
...
' ART (URSACHE) DES SCHADENS (abgekürzt ADS)
...
Bea: wenn das Meldedatum desc Schadens tatsächlich ohne Jahr ist, dann über Lookup über F_Schaden zur this.SK_Schaden';
...
'aus MD36_SDS_Bilanz_Summensatz.SNR2 (Schadennummer mit Prüfziffer)';
...
'aus MD36_SDS_Bilanz_Summensatz.VNR (Prüfziffer???)
...
und für Einträge aus MD07_Spaet_Rueckvers_Pausch 
mittels
C_Rueckstellungsart = Anzahl Spätschäden (13425)
C_Betragsart = Anzahl Schäden (13424)
...
Bea: Wird mehr als ein gültiger Versicherungsnehmer gefunden, so, wird der mit dem größten fachlichen Beginn verwendet.
...
Wird mehr als ein gültiger Vertrag  gefunden, so wird der oberste Vertrag gem. folgender Sortierung genommen: 
...
über	ER02_Teilschaden_ER01_BW 
	->	PA01_PA02_ER02_BL
	->	PA02_PartnerRolle_Par_01_HBS.RollenId = Auslandsbüro (=‚ZFAG‘ = 2469)

Bea: Wird mehr als ein gültiger Partner gefunden, so, wird der mit dem größten FACHLICH_BEGINN verwendet
...
über 	ER02_Teilschaden_ER01__BW
	->	ER01_Schaden_BH
	->	PA01_PA02_ER01_BL	
mit Partnerrolle = VN
...
über 	ER02_Teilschaden_ER01_BW
	...
	->	ER01_WE03_Deckungsspiegel_BL
und  maximalem Fachlich_Gueltig_Beginn in ER01_WE03_DeckSpie_SCH_01_LBS 
(falls es mehrere gültige Deckungen geben sollte, wird das mit maximalem fachlichem Gültig_beginn genommen -> es wird genau eine Deckung selektiert!)
';
...
aus MD28_Telegutachten.Anzahl_Telegutachten_KH für Kraftfahrt Haftpflicht,
aus MD28_Telegutachten.Anzahl_Telegutachten_KK für Kraftfahrt Kasko,
aus MD28_Telegutachten.Anzahl_Telegutachten_PH für Allgemeine Haftpflicht
...
'... ist die Sparte, zu der die Telegutachten gehören, also Kraftfahrt Haftpflicht, Kraftfahrt Kasko oder Allgemeine Haftpflicht (hier nur Privathaftpflicht)
...
dabei ist this.ID_Sparte gefüllt wie das Attribut ID_Sparte in dieser Tabelle, also:
...
'Anzahl der Zahlungen. Alternativ kann man auch über SK_Zahlungen_Hist zählen, nicht aber über SK_Zahlung, da diese Spalte bei den Regresseingängen aus CD für Zahlungseingänge an verschiedenen Tagen identisch ist.';
...
'Schlüssel für die Historisierung: bei generierten Zahlungseingängen aus FS-CD abweichend von SK_Zahlung: aus LE01_Zahlung_SHUKR_01_HBS.FK_LE01_Zahlung + Ausgleichsbuchungsdatum CD';
...
'Anzahl der Zahlungspositionen - zum Zählen der Zahlungspositionen. Alternativ kann man auch über SK_Zahlung_Detail_Hist zählen, nicht aber über SK_Zahlung_Detail, da letztere Spalte bei den Regresseingängen aus CD für Zahlungseingänge an verschiedenen Tagen und den unterschiedlichen Leistungsarten identisch ist.';
...
'Schlüssel für die Historisierung. Bei generierten Zahlungseingängen aus FS-CD zusammengesetzt aus LE01_Zahlung_SHUKR_01_HBS.FK_LE01_Zahlung + Ausgleichsbuchungsdatum CD + Leistungsart. 
...
Führende Quelle für die Bewirtschaftung dieser Aggregationstabelle sind prinzipiell die Fakt-Tabellen F_SCHADEN und F_SCHADEN_YTD (siehe Kapitel 2). Aus der folgenden Tabelle sind die Ziel-Attribute dieser Aggregation zu entnehmen. Als Abgrenzung zur AGG_SCHADEN_2 steht hier das Meldejahr und nicht der Meldemonat im Fokus. 

Da alle Attribute der AGG_SCHADEN_1 aus den Attributen der AGG_SCHADEN_2 ermittelt werden können und die Kennzahlen identisch sind, basiert aktuell der Aufbau der AGG_SCHADEN_1 direkt auf der AGG_SCHADEN_2 und nicht auf den originären Fakt-Tabellen.

Anmerkung:
Im zugehörigen DDL steht zwischen dem Create und dem Tablespace:
...
Führende Quelle für die Bewirtschaftung dieser Aggregationstabelle sind prinzipiell die Fakt-Tabellen F_SCHADEN und F_SCHADEN_YTD. Als Abgrenzung zur AGG_SCHADEN_1 steht hier der Meldemonat und nicht das Meldejahr im Fokus. 
Da alle Attribute der AGG_SCHADEN_1 aus den Attributen der AGG_SCHADEN_2 ermittelt werden können und die Kennzahlen identisch sind, basiert aktuell (11.2018) der Aufbau der AGG_SCHADEN_1 direkt auf der AGG_SCHADEN_2 und nicht auf den originären Fakt-Tabellen.
Die Kennzahlen werden alle als Summe aggregiert, wobei die Kennzahl ANZAHL (Anzahl Schäden) die Summe von 1 (Anzahl Datensätze der F_SCHADEN) darstellt.
...
'... enthält Informationen zum (gesamten) Schaden, wann und an welcher Stelle dieser zuletzt geaendert wurde. 
Da fachlich keine Vollhistorie notwendig ist, muss nur der letzte Änderungszeitpunkt je Quartal gespeichert werden, 
...
zunächst mit Dummy (konstant=-1) gefüllt,
danach aus SC02_Schluesselbedeutung (noch keine Domäne).';

COMMENT ON TABLE DIM_BerufungRevdurch IS
'aus SC02_Schluesselbedeutung
(Domäne: BERUFUNGSVERURSACHER)';

COMMENT ON TABLE DIM_BeschaedigGrad IS
'aus SC02_Schluesselbedeutung
(Domäne: BESCHAEDIGUNGSGRADE)';

COMMENT ON TABLE DIM_BeschaedigTyp IS
'aus SC02_Schluesselbedeutung
(Domäne: OBJEKTKATEGORIEN)';

COMMENT ON TABLE DIM_BestandsbezArt IS
'aus SC02_Schluesselbedeutung
(Domäne: BESTANDSBEZIEHUNGSART)';
...
'aus SC02_Schluesselbedeutung
(Domäne: BEWERTUNG_VTP)';

COMMENT ON TABLE DIM_Bilanz_Meldeper IS
'aus SC02_Schluesselbedeutung
(Domäne: BILANZ_MELDEPERIODE)';
...
'aus SC02_Schluesselbedeutung
(Domäne: SAP_CM_ADRCITYT)';

COMMENT ON TABLE DIM_CodeOrtsteil IS
'aus SC02_Schluesselbedeutung
(Domäne: SAP_CM_ADRCITYPRTT)';
...
aus SC02_Schluesselbedeutung
(Domänen: REGRESS_KLASSIFIZIERUNGSART und RUECKST_KLASSIFIZIERUNGSART)';

COMMENT ON TABLE DIM_KlassifizSchluss IS
'aus SC02_Schluesselbedeutung
(Domäne: KLASSIF_SCHADENSCHLUSS)';
...
aus 	SC02_Schluesselbedeutung
und SC07_Harmonisierung
(Domäne: LEISTUNGSARTEN und RAW-Attributname: C_Leistungsart_B)';

COMMENT ON TABLE DIM_Meldeweg IS
'aus SC02_Schluesselbedeutung
(Domäne: SCHADENMELDEWEGE)';

COMMENT ON TABLE DIM_Monat IS
'Dimensionstabelle für Monate, die für alle Monatsangaben genutzt werden sollte.';

COMMENT ON TABLE DIM_ObjektArt IS
'aus SC02_Schluesselbedeutung 
(Domäne: OBJEKTSUBKATEGORIEN)';
...
aus SC02_Schluesselbedeutung
(Domäne: PARTNERGEMEINSCHAFTSART)';
...
'... ist die erste Ebene der Hierarchie der Regionaldirektionen und stellt die heute gültigen RD’en dar, während die unterste Ebene die originären (auch ehemals gültigen RD’en) enthält

aus MD16_Regionaldirektion';

COMMENT ON TABLE DIM_RD_Ebene2 IS
'... ist die zweite Ebene der Hierarchie der Regionaldirektionen und stellt die heute gültigen Direktionsbereiche dar.
...
'aus SC02_Schluesselbedeutung
(Domäne: GERICHTSVERFAHRENINSTANZEN)';

COMMENT ON TABLE DIM_Region IS
'aus SC02_Schluesselbedeutung
(Domäne: LAENDERREGIONEN)';
...
'aus SC02_Schluesselbedeutung
(Domäne: RESERVIERUNGSMETHODEN)';

COMMENT ON TABLE DIM_RueckversichArt IS
'aus SC02_Schluesselbedeutung
(Domäne: RUECKVERSICHERUNGSART)
...
'über SC02_Schluesselbedeutung
(Domäne: SACHB_GRUPPEN)';
...
'aus SC02_Schluesselbedeutung
(Domäne: PARTNER_SCHUTZKENNZEICHEN)';
...
aus SC02_Schluesselbedeutung
(Domäne: SCHADENSPARTEN)';

COMMENT ON TABLE DIM_TV_Projekt IS
'aus MD37_TV_Projekte

Zusätzlich muss ein Dummy mit der ID_TV_Projekt=-1 erzeugt werden:
...
'aus SC02_Schluesselbedeutung
(domäbne: GERICHTSVERFAHRENSARTEN)';

COMMENT ON TABLE DIM_Verfahrensggst IS
'aus SC02_Schluesselbedeutung
(Domäne: GERICHTSVERFAHRENSGEGENSTAENDE)';

COMMENT ON TABLE DIM_Verfahrensstatus IS
'aus SC02_Schluesselbedeutung
(Domäne: GERICHTSVERFAHRENSSTATUS)';
...
'... enthält J/N Kennzeichen zu beschädigten Objekten, die in der Regel als Selektionskriterien benutzt werden. 
...
zusätzlich ein Eintrag mit
ID_Schadenrueckstellungsart = ''Anzahl Spätschäden''
ID_RueckstellungsBetragsart = ''Anzahl Schäden''
...
Für die Daten aus FS-CD wird ein einheitlicher Datensatz angelegt mit folgenden Werten:
ID_Betragstyp ="nicht geliefert" (-1)
ID Zahlungsart = „Rückzahlung“ (99)
...
'Kontrollreport aus SAP: In SAP werden Kontrollzahlen generiert, die zwecks Abgleich in das DWH geladen werden. Ziel ist es, die Vollständigkeit der wichtigsten Kennzahlen sicherzustellen.';

COMMENT ON TABLE F_SCHADEN_YTD IS
'In vielen Berichten sind nicht nur die kumulierten Werte von Schäden über die gesamte Laufzeit des Schadens von Interesse, sondern auch Zahlungen, Regresse etc. die im Stichtagsjahr angefallen sind.
...
Anmerkung:
Im zugehörigen DDL steht zwischen dem PK-Constraint und dem Tablespace:
